...
../software/baypass_public/sources/g_baypass -npop 52 -gfile ./input/G.hgdp_pods_10000 -efile ./input/covariates -scalecov  -outprefix ./results_standard/hgdp_stdis_10000_pods
```
